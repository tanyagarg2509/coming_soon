window.onload = function () {
    ...
    for (let i = 0; i < 40; i++) {
        particles.push({
            ...
            color: Math.random() > .5 ? "#4c0574" : Math.random() > .5 ? "#fe1f63" : "#1ffe92"
        });
    }
...
//add event listener
myBtn.addEventListener('ontouchstart', function (event) {
    window.location.href = 'Brochurewebsitenew.pdf';
});
//onclick = "window.location.href='Brochurewebsitenew.pdf';"